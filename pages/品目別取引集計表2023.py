...
# エクセルファイルからデータを読み込む
data_frames = {}
for month in range(2301, 2313):  # 2401から2412まで
...
def selected_item_mount():
  selected_item = st.multiselect("品目を選んでください（複数選択可）", 
                                  aggregated_df.index,
                                  key=3)
  # 選択された項目名に基づいて、列2301から列2312までのデータを抽出
  selected_item_data = aggregated_df.loc[selected_item, '2301':]
